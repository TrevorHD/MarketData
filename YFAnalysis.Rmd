...
SPWeeklyMods[[1]] <- names(sort(SPWeeklyTop, decreasing = TRUE)[1])
logreg(SPWeeklyMods[[1]], dataTrain = SPWeeklyTrain, output = "confMatrix")

# Find top 10 models for ppv
SPWeeklyTop <- unlist(sapply(1:8, FUN = logreg.comb, dataTrain = SPWeeklyTrain, output = "ppv"))
sort(SPWeeklyTop, decreasing = TRUE)[1:10]
SPWeeklyMods[[2]] <- names(sort(SPWeeklyTop, decreasing = TRUE)[1])
logreg(SPWeeklyMods[[2]], dataTrain = SPWeeklyTrain, output = "confMatrix")
...
SPWeeklyMods[[3]] <- paste0("Direction~", paste0(predVec, collapse = "+"))
...
while(length(predVecFwd) < 36){
  ...
  prevmaxacc <- c(prevmaxacc, maxacc)}
prevmaxacc[length(prevmaxacc)]
SPWeeklyMods[[4]] <- paste0("Direction~", paste0(predVecFwd, collapse = "+"))
...
while(length(predVec) > 1){
  ...
  prevmaxacc <- c(prevmaxacc, maxacc)}
prevmaxacc[length(prevmaxacc)]
SPWeeklyMods[[5]] <- paste0("Direction~", paste0(predVec, collapse = "+"))
...
while(length(predVecFwd) < 36){
  ...
  prevmaxacc <- c(prevmaxacc, maxacc)}
prevmaxacc[length(prevmaxacc)]
SPWeeklyMods[[6]] <- paste0("Direction~", paste0(predVecFwd, collapse = "+"))
...
sapply(SPWeeklyMods, FUN = logreg, dataTrain = SPWeeklyTest, output = "accuracy")

# Compare model test PPV
sapply(SPWeeklyMods, FUN = logreg, dataTrain = SPWeeklyTest, output = "ppv")
...
for(i in 1:6){
  print(returns(SPWeeklyMods[[i]], data = SPWeekly, final = TRUE))}
