...
for(i in c(1, 5, 6)){
  ...
  text(x = rep(10, 3)[j], y = rep(7.8, 3)[j], labels = c("Model 1", "Model 5", "Model 6")[j], adj = 0)
  ...
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange < 0]), lty = 2, col = "red")
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange > 0]), lty = 2, col = "green")
  text(x = rep(10, 3)[j], y = rep(15, 3)[j], labels = c("Model 1", "Model 5", "Model 6")[j], adj = 0)
  text(x = rep(110, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[1]),
       col = "red", adj = 0)
  text(x = rep(140, 3)[j], y = rep(15, 3)[j], labels = "/", adj = 0)
  text(x = rep(150, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[2]),
...
for(i in c(2, 7, 8)){
  ...
  lines(returns.damod("none", data = SPWeeklyTest))
  text(x = rep(10, 3)[j], y = rep(7.8, 3)[j], labels = c("Model 2", "Model 7", "Model 8")[j], adj = 0)
  ...
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange < 0]), lty = 2, col = "red")
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange > 0]), lty = 2, col = "green")
  text(x = rep(10, 3)[j], y = rep(15, 3)[j], labels = c("Model 2", "Model 7", "Model 8")[j], adj = 0)
  text(x = rep(110, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[1]),
       col = "red", adj = 0)
  text(x = rep(140, 3)[j], y = rep(15, 3)[j], labels = "/", adj = 0)
  text(x = rep(150, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[2]),
...
for(i in c(3, 9, 10)){
  ...
  lines(returns.damod(formula(SPWeeklyDMod[[i]]), data = SPWeeklyTest, daType = "lda", lrisk = TRUE), col = "purple")
  lines(returns.damod("none", data = SPWeeklyTest))
  text(x = rep(10, 3)[j], y = rep(7.8, 3)[j], labels = c("Model 3", "Model 9", "Model 10")[j], adj = 0)
  ...
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange < 0]), lty = 2, col = "red")
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange > 0]), lty = 2, col = "green")
  text(x = rep(10, 3)[j], y = rep(15, 3)[j], labels = c("Model 3", "Model 9", "Model 10")[j], adj = 0)
  text(x = rep(110, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[1]),
       col = "red", adj = 0)
  text(x = rep(140, 3)[j], y = rep(15, 3)[j], labels = "/", adj = 0)
  text(x = rep(150, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[2]),
...
for(i in c(4, 11, 12)){
  ...
  lines(returns.damod(formula(SPWeeklyDMod[[i]]), data = SPWeeklyTest, daType = "qda", lrisk = TRUE), col = "purple")
  lines(returns.damod("none", data = SPWeeklyTest))
  text(x = rep(10, 3)[j], y = rep(7.8, 3)[j], labels = c("Model 4", "Model 11", "Model 12")[j], adj = 0)
  ...
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange < 0]), lty = 2, col = "red")
  abline(h = mean(plotdat$SPWeeklyTest.PctChange[plotdat$SPWeeklyTest.PctChange > 0]), lty = 2, col = "green")
  text(x = rep(10, 3)[j], y = rep(15, 3)[j], labels = c("Model 4", "Model 11", "Model 12")[j], adj = 0)
  text(x = rep(110, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[1]),
       col = "red", adj = 0)
  text(x = rep(140, 3)[j], y = rep(15, 3)[j], labels = "/", adj = 0)
  text(x = rep(150, 3)[j], y = rep(15, 3)[j], labels = as.numeric(table(plotdat$SPWeeklyTest.Direction)[2]),
