...
``` {r Figure19, fig.height = 8.3, warning = FALSE, message = FALSE, fig.cap = "\\label{fig:Figure19} ROC curves for the models selected by maximising accuracy. Accuracy, positive predictive value (PPV), and area under the curve (AUC) are listed for each plot; the red dot represents model sensitivity and specificity."}
...
for(i in c(1, 3, 4)){
  ...
  text(x = rep(1.1, 3)[j], y = rep(1, 3)[j],
...
``` {r Figure20, fig.height = 8.3, warning = FALSE, message = FALSE, fig.cap = "\\label{fig:Figure20} ROC curves for the models selected by maximising PPV. Accuracy, positive predictive value (PPV), and area under the curve (AUC) are listed for each plot; the red dot represents model sensitivity and specificity."}
